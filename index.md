...
_IMPORTANT: Only the above link contains the full release with trained models, templates, etc. Do not use the "Download" button on Github because it contains only smaller scripts. Github does not accept files above 100mb in main repositories._  
